...
DESCS_ERROR = {
    ...
    ERROR_UNFINISHED_TRANSACTION:_("A previous package management transaction was interrupted."),
    ERROR_CANCELLED_PRIORITY:_("The transaction has been canceled and will be retried when the system is idle."),
    ERROR_LOCK_REQUIRED:_("A package manager lock is required."),
    }
...
STRINGS_ERROR = {
    ...
    ERROR_UNFINISHED_TRANSACTION:_("Unfinished transaction"),
    ERROR_LOCK_REQUIRED:_("Lock required"),
    }
